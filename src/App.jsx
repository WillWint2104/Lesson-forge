...
function MathFrac({ num, den }) {
  ...
  return (
    ...
    >
      <span style={{ ...p, borderBottom: '1px solid ' + C.black, paddingBottom: '1px' }}>
...
═══════════════════════════════════════════ */
const _renderers = {}
function registerRenderer(type, Comp) {
...
function buildGenPrompt(topic, section, year, count) {
...
function buildDiagramRevisionPrompt(section) {
...
export default function App() {
  const [input, setInput] = useState(''),
    ...
    [qaPatched, setQaPatched] = useState(false),
          ...
          <div>
            ...
            {genRunning && (
              <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                ...
                />
                <span
                  style={{ fontSize: '13px', fontWeight: 600, color: C.orange, fontFamily: SANS }}
                >
                  {genStage === 'generating'
                    ? 'Generating…'
                    : genStage === 'diagrams'
          ...
          <div>
            ...
            >
              <div>
                ...
                <p
                  style={{ fontSize: '11px', color: C.slate, fontFamily: MONO, margin: '4px 0 0' }}
                >
